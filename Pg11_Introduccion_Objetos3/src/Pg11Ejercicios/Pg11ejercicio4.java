...
public class Pg11ejercicio4 {

	public static void main(String[] args) {
		//se ha creado el objeto a la misma vez que añado el elemento del Arraylist, el profesor crea primero los objetos y después los añade.
		ArrayList<FechasPersona> fechas = new ArrayList<FechasPersona>();
		FechasPersona pf1 = new FechasPersona (new Fecha(), new Fecha(), new Fecha());
		FechasPersona pf2 = new FechasPersona (new Fecha("3/5/1981"), new Fecha(4,9,2000), new Fecha(20,10,2002));
		fechas.add(pf1);
		fechas.add(pf2);
		fechas.add(new FechasPersona(new Fecha(6,7,1980), new Fecha(6,12,2000), new Fecha(8,7,2002)));
		//esto no se pide pero es para imprimir los objetos creados del arrayList

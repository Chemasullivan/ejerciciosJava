...
public class Pg11ejercicio2 {

	public static void main(String[] args) {
	ArrayList<Fecha> fechas =new ArrayList<Fecha>();
	Fecha f1 = new Fecha(); //se puede crear a la misma vez el objeto dentro del parentesis fechas.add(new Fecha(1,1,2000);
	fechas.add(new Fecha(3,10,1981));
	fechas.add(new Fecha("5/10/2025"));
	Fecha f4 = new Fecha(2,6,1990);
	fechas.add(f1); fechas.add(f4);
	System.out.println(fechas.get(0));
	System.out.println(fechas.get(1));
	System.out.println(fechas.get(2));
	System.out.println(fechas.get(3));
	
	fechas.remove(1); fechas.remove(f1);
	System.out.println(fechas.get(0));
	System.out.println(fechas.get(1));
	//System.out.println(fechas.get(2)); //esto no existe ya despues de borrar los objetos de posiciones anteriores
	//System.out.println(fechas.get(3)); //esto no existe ya
	
	fechas.set(0, f4); //cambia el elemento en el indice 0 a f4
	System.out.println(fechas.get(0));
	System.out.println(fechas.get(1));
	System.out.println(fechas.get(2)); //esto no existe ya despues de borrar los objetos de posiciones anteriores
	System.out.println(fechas.get(3));

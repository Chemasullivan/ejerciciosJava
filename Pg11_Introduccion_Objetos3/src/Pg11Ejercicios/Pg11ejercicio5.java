...
public class Pg11ejercicio5 {
	...
	public static void main(String[] args) {
		...
		Personas[0]=new Persona(nombre,fechas);
		System.out.println(Personas[0]);
		
		nombre="Juan";
		fechas[Persona.FNacimiento]=new Fecha(5,7,1985);
		fechas[Persona.FBoda]=new Fecha(3,6,2012);
		fechas[Persona.FTrabajo]=new Fecha(10,11,2005);
		Personas[1]=new Persona(nombre,fechas);
